...
class ModuleTrainer(object):
        ...
        with TQDM() as pbar:
            ...
            for epoch_idx in range(initial_epoch,num_epoch):
                ...
                for batch_idx in range(num_batches):
                    ...
                    batch_logs['loss'] = loss.data
                    callback_container.on_batch_end(batch_idx, batch_logs)

                # TODO: Do this here or in callbacks.py?
    ...
    def evaluate(self,
        ...
        for batch_idx in range(num_batches):
            ...
            eval_logs['val_loss'] = (samples_seen*eval_logs['val_loss'] + loss.data*batch_size) / (samples_seen+batch_size)
